# 2016.10.24 19:08:31 WIT
#Embedded file name: /usr/lib/enigma2/python/Components/Converter/MetProvider.py
...
class MetProvider(Converter, object):
    ...
    def getText(self):
        ...
        if isinstance(ref, eServiceReference):
            ...
            providerlist = serviceHandler.list(eServiceReference('%s (channelID == %08x%04x%04x) && %s FROM PROVIDERS ORDER BY name' % (typestr[:20],
